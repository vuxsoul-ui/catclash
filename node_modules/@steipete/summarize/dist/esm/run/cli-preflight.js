...
import { applyHelpStyle, attachRichHelp, buildDaemonHelp, buildProgram, buildRefreshFreeHelp, buildSlidesProgram, buildTranscriberHelp, } from './help.js';
export function handleHelpRequest({ normalizedArgv, envForRun, stdout, stderr, }) {
    ...
    if (topic === 'slides') {
        const slidesProgram = buildSlidesProgram();
...
export async function handleRefreshFreeRequest({ normalizedArgv, envForRun, fetchImpl, stdout, stderr, }) {
...
export async function handleDaemonCliRequest(ctx) {
...
//# sourceMappingURL=cli-preflight.js.map