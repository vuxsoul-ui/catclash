...
export async function transcribeMediaUrl({ fetchImpl, env, url, filenameHint, durationSecondsHint, openaiApiKey, falApiKey, notes, progress, }) {
...
export function normalizeHeaderType(value) {
    if (!value)
        return null;
