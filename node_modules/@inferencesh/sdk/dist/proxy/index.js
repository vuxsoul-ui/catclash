...
function isAllowedDomain(host, extraDomains) {
    if (VALID_DOMAIN_PATTERN.test(host))
        return true;
    if (extraDomains) {
 ...
 */
export async function processProxyRequest(adapter, options) {
 ...
 */
export const passthrough = (res) => Promise.resolve(res);
/**
