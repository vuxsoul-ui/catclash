 ...
 */
export declare function isAdHocConfig(config: AgentOptions): config is AdHocAgentConfig;
/**
 * Type guard to check if config is template-based
 */
export declare function isTemplateConfig(config: AgentOptions): config is TemplateAgentConfig;
/**
 * Status of the chat
 */
 ...
 */
export declare function isClientTool(tool: AgentTool | ClientTool): tool is ClientTool;
/**
 * Extract just the schemas from a mixed array of tools
 */
export declare function extractToolSchemas(tools: (AgentTool | ClientTool)[]): AgentTool[];
/**
 * Extract client tool handlers as a map
 */
export declare function extractClientToolHandlers(tools: (AgentTool | ClientTool)[]): Map<string, ClientToolHandlerFn>;
/**
