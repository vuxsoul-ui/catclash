...
export const AppCategoryText = "text";
export const AppCategoryChat = "chat";
...
export const ChatStatusCompleted = "completed";
export const PlanStepStatusPending = "pending";
export const PlanStepStatusInProgress = "in_progress";
export const PlanStepStatusCompleted = "completed";
export const PlanStepStatusCancelled = "cancelled";
...
export const CloudTensorDock = "tensordock";
export const CloudRunPod = "runpod";
export const CloudLatitude = "latitude";
export const CloudJarvisLabs = "jarvislabs";
export const CloudOblivus = "oblivus";
export const CloudPaperspace = "paperspace";
export const CloudDatacrunch = "datacrunch";
...
export const WidgetNodeTypeBadge = "badge";
export const WidgetNodeTypeButton = "button";
export const WidgetNodeTypeInput = "input";
export const WidgetNodeTypeSelect = "select";
