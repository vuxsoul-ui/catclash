-- Fix active runtime errors for core gameplay functions.
-- Scope: open_crate, reroll_cat_stats, resolve_match
-- - open_crate: fix uuid/text mismatch in user_id predicate
-- - reroll_cat_stats: remove cats.updated_at dependency
-- - resolve_match: remove cats.updated_at dependency
